...
import 'package:bacaku/app/modules/home/view/bunyi_read_view.dart';
import 'package:bacaku/utils/constants/colors.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class BunyiListView extends StatelessWidget {
  const BunyiListView({super.key});
              ...
              GridView.builder(
                ...
                itemBuilder: (context, index) {
                  return GestureDetector(
                    onTap: () => Get.to(()=> BunyiReadView(id: index)),
                    child: Container(
